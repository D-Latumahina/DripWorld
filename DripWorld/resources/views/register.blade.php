        ...
        <div class="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form action="/register" method="post" id="registration-form">
            ...
            <div class="form-group">
              ...
              <input value="{{old('name')}}" name="name" id="name-register" class="form-control" type="text" placeholder="First & Last Name" autocomplete="off" />
              @error('name')
            ...
            <br>
            <button type="submit" class="py-3 mt-4 btn btn-lg btn-dark btn-block">Sign up</button>
          </form>
        </div>
      </div>
    </div>
